 ...
 * @author Student
 */
public class dlgGestiónEmpleado extends javax.swing.JDialog {
     ...
     */
    public dlgGestiónEmpleado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        for (int i = 0; i < empleadoList.size(); i++) {
            ...
            if (empleado.getNombre().toLowerCase().contains(txtBuscar.getText().toLowerCase())) {
                Object row[] = {empleado.getCedula(), empleado.getNombre(),
                    empleado.getApellidos(),empleado.getGenero(),empleado.getFechaNacimiento,empleado.getEmail};
                tblModel.addRow(row);
            }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        FrmNewEmpleado winNew = new FrmNewEmpleado(null, true, empleadoList, 1);
        winNew.setTitle("Agregar un nuevo Empleado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgGestiónEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgGestiónEmpleado dialog = new dlgGestiónEmpleado(new javax.swing.JFrame(), true);
